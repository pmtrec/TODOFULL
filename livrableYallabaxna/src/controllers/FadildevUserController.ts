...
export class AuthController {
    ...
    constructor(private  userServiceFadilDev: UserServiceFadilDev) {
    ...
    async login(req: Request, res: Response): Promise<Response> {
        ...
        const user: User | null = await this.userServiceFadilDev.findByMail(email);
        if (!user) {
    ...
    async refresh(req: Request, res: Response): Promise<Response> {
        ...
        try {
            ...
            const user: User | null = await this.userServiceFadilDev.findUserById(payload.userId);
